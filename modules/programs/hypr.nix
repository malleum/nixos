    ...
    in
    {
      ...
      wayland.windowManager.hyprland = {
        ...
        settings = lib.mkForce {
          ...
          monitor = (
            if hostConfig.name == "magnus" then
              [
          ...
          general = {
            ...
            "col.active_border" =
              "rgba(${config.stylix.base16Scheme.base04}ff) rgba(${config.stylix.base16Scheme.base0C}ff) 30deg";
          ...
          animations = {
            ...
            animation =
              let
                slide = "${if hostConfig.name == "magnus" then "slidevert" else "slide"}";
              in
              [
